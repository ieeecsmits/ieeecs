...
const events = [
  {
    ...
    description: 'A competitive web development challenge where participants showcase their frontend skills. Participants compete in real-time UI/UX challenges and design battles.',
    short_description: 'Competitive frontend development challenge.',
    ...
    tags: ['Frontend', 'UI/UX', 'Web Dev'],
    is_featured: false,
  },
  {
    title: 'Career Blueprint / Roadmap by Deolite MD Sandeep Mishra Sir',
    description: 'An insightful session on career planning and development in the tech industry. Industry veterans share their roadmap to success and guide students on building professional careers.',
    short_description: 'Career guidance and roadmap session with industry experts.',
    event_type: 'seminar',
    status: 'completed',
    date: '2026-03-26',
    time: '14:00:00',
